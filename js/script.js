    ...
    return {
      ...
      init: function() {
        ...
        for (var i = 0; i < numChannels; i++) {
          ...
          newAudio.innerHTML = '<source src="https://raw.githubusercontent.com/bernarddeluna/oldRadio/gh-pages/audio/' + i + '.mp3" type="audio/mpeg"><source src="https://raw.githubusercontent.com/bernarddeluna/oldRadio/gh-pages/audio/' + i + '.ogg" type="audio/ogg">';
